...
class SerializeableFieldType implements IndexableFieldType, Serializable {
	 ...
	 * <code>ref</code>
	 */
	public SerializeableFieldType(SerializeableFieldType ref) {
	 ...
	 * 
	 * @param value
	 *            true if this field should be stored.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 * @see #stored()
	 */
	 ...
	 * 
	 * @param value
	 *            true if this field should be tokenized.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 * @see #tokenized()
	 */
	...
	/**
	 * Set to <code>true</code> if this field's indexed form should be also
	 * stored into term vectors.
	 * 
	 * @param value
	 *            true if this field should store term vectors.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 ...
	 * term vector for this field.
	 * 
	 * @param value
	 *            true if this field should store term vector offsets.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 ...
	 * 
	 * @param value
	 *            true if this field should store term vector positions.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 ...
	 * 
	 * @param value
	 *            true if this field should omit norms.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 * @see #omitNorms()
	 */
	 ...
	 * 
	 * @param type
	 *            numeric type, or null if the field has no numeric type.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 * @see #numericType()
	 */
	 ...
	 * numerically so that {@link NumericRangeQuery} can be used at search time.
	 * <p>
	 ...
	 * 
	 * @param type
	 *            DocValues type, or null if no DocValues should be stored.
	 * @throws IllegalStateException
	 *             if this FieldType is frozen against future modifications.
	 * @see #docValueType()
	 */
