...
public class JavaSerializationSerializer implements Serializer, PofSerializer {
	...
	public static final class Codec implements com.tangosol.io.pof.reflect.Codec {
		@Override
		public void encode(PofWriter out, int index, Object value) throws IOException {
			Binary bin = new Binary(toBytes(value));
			out.writeBinary(index, bin);
		}

		@Override
		public Object decode(PofReader in, int index) throws IOException {
			byte[] data = in.readByteArray(index);
