...
import org.gridkit.coherence.search.lucene.DocumentSchema;
...
public class Sample {
	...
	public void usingGridSearch() {
		...
		extractor.addTokenizedField("title", "getTitle");
		extractor.addTokenizedField("author", "getAuthor");
		extractor.addTokenizedField("content", "getContent");
		extractor.addTokenizedField("tags", "getSearchableTags");
