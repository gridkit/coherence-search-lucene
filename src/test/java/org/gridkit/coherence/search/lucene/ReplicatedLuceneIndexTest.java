...
public class ReplicatedLuceneIndexTest extends LuceneGenericFuntionalTestSet.Proxy {
	...
	public static void initCacheConfig() {
		...
		ReplicatedScheme scheme = CacheConfig.replicatedScheme();
	...
	@Before
	public void init() {
		testSet = cloud.node("client").exec(new Callable<LuceneGenericFuntionalTestSet>() {
			@Override
